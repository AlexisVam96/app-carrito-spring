...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers(HttpMethod.GET,"/api/usuarios",
				"/api/usuarios/**", "/api/productos","/api/categorias","/api/categorias/**",
				"/api/compras/**", "/images/**" , "/api/productos/page/**",
				"/api/uploads/img/**","/api/productos/**").permitAll()
